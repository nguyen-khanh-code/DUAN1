                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Quan Tri</a></li>
                                    ...
                                    <div class="live-preview">
                                        <form action="?act=them-khuyen-mai" method="POST">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="emailidInput" class="form-label">So Luong Ma Mot Nguoi</label>
                                                        <input type="text" class="form-control" placeholder="Nhap So Luong Ma Mot Nguoi" name="so_luong_ma_mot_nguoi">
                                                        <span class="text-danger">
                                                            <?= !empty($_SESSION['errors']['so_luong_ma_mot_nguoi']) ? $_SESSION['errors']['so_luong_ma_mot_nguoi'] : '' ?>
