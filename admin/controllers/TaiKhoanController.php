        ...
        public function formEditKhuyenmai(){
         ...
         public function postEditKhuyenmai(){
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST'){
                ...
                $so_luong_ma_mot_nguoi = $_POST['so_luong_ma_mot_nguoi'];
                ...
                if (empty($so_luong_ma_mot_nguoi)){
                    $errors['so_luong_ma_mot_nguoi'] = 'so_luong_ma_mot_nguoi la bat buoc';
                }
    
                if (empty($errors)) {
                    
    
                    $this->modelTaiKhoan-> uppdateDatakhuyenmai($id, $ma_khuyen_mai, $ten_khuyen_mai, $muc_giam, $so_luong, $so_luong_ma_mot_nguoi);
    ...
    public function Addkhuyenmai(){
        if ($_SERVER['REQUEST_METHOD'] == 'POST')
            ...
            if (empty($errors)) {
                ...
                $this->modelTaiKhoan->addkhuyenmai( $ma_khuyen_mai, $ten_khuyen_mai, $muc_giam, $so_luong, $so_luong_ma_mot_nguoi);
