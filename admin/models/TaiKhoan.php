...
class TaiKhoan{
    ...
    //     try{
    //         $sql = 'SELECT tai_khoans.*, '
    //     }
    // }



    public function posDatakhachhang($name,$sdt, $email, $password, $chuc_vu_id){
        try{
    ...
    public function uppdateDatakhuyenmai($id, $ma_khuyen_mai, $ten_khuyen_mai, $muc_giam, $so_luong, $so_luong_ma_mot_nguoi)
    {
        try{
            ...
            $sql = 'UPDATE khuyen_mais SET ma_khuyen_mai = :ma_khuyen_mai, ten_khuyen_mai = :ten_khuyen_mai,
             muc_giam = :muc_giam, so_luong = :so_luong, so_luong_ma_mot_nguoi = :so_luong_ma_mot_nguoi WHERE id = :id';
            ...
            $stmt->bindParam(':so_luong_ma_mot_nguoi', $so_luong_ma_mot_nguoi);
    ...
    public function addkhuyenmai( $ma_khuyen_mai, $ten_khuyen_mai, $muc_giam, $so_luong, $so_luong_ma_mot_nguoi){
        try{
            // var_dump( $ma_khuyen_mai, $ten_khuyen_mai, $muc_giam, $so_luong, $so_luong_ma_mot_nguoi);
            // die();
            $sql = 'INSERT INTO khuyen_mais  (ma_khuyen_mai,ten_khuyen_mai,muc_giam, so_luong , so_luong_ma_mot_nguoi)
             VALUES (:ma_khuyen_mai,:ten_khuyen_mai,:muc_giam, :so_luong , :so_luong_ma_mot_nguoi)';
